...
namespace WebApplication1.Controllers
{
    public class OGameCoordinatesController : Controller
    {
        ...
        [Authorize]
        public async Task<ActionResult> Create([Bind(Include = "Id,Y,X")] OGameCoordinate oGameCoordinate)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Y,X")] OGameCoordinate oGameCoordinate)
        {
            if (ModelState.IsValid)
            {
